...
const Section3 = () => {
  const videos = [
    { id: 1, url: "https://www.youtube.com/embed/64WRGY2iK74", thumbnail: "https://img.youtube.com/vi/64WRGY2iK74/maxresdefault.jpg" },
    { id: 2, url: "https://www.youtube.com/embed/l37o8odjSD4", thumbnail: "https://img.youtube.com/vi/l37o8odjSD4/maxresdefault.jpg" },
        ...
        <div className="mt-12">
          <div className="flex items-center justify-between">
            ...
            <div className="sm:flex gap-3 hidden">
              ...
              <button onClick={nextSlide} disabled={currentIndex + itemPage >= videos.length} className="disabled:opacity-50 h-5 w-3">
