        ...
        <div className='sm:flex justify-center gap-4 mt-6'>
            ...
            <div className='flex justify-center '>
                <div className='flex justify-center items-center border-[#B6AC00] bg-[#FFF761] border rounded-[4px]  w-[335px] sm:w-[251px] h-[40px] '>
                    <a href="https://www.expertisoracademy.in/courses/MasterTech-1-Year-Mentorship-Program-1735308892432-676eb65c9f0f402d2004afae" className='font-inter font-semibold text-black  text-[16px] leading-[100%] tracking-[0%] align-middle'>Join Now</a>
                </div>
            </div>
